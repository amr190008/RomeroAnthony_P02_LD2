    ...
    void UpdateWeaponAiming()
    {
        if (m_WeaponSwitchState == WeaponSwitchState.Up)
        {
            ...
            if (isAiming && activeWeapon)
            {
                ...
                SetFOV(Mathf.Lerp(m_PlayerCharacterController.playerCamera.m_Lens.FieldOfView, activeWeapon.aimZoomRatio * defaultFOV, aimingAnimationSpeed * Time.deltaTime));
            }
            else
            {
                ...
                SetFOV(Mathf.Lerp(m_PlayerCharacterController.playerCamera.m_Lens.FieldOfView, defaultFOV, aimingAnimationSpeed * Time.deltaTime));
            }
        }
    }
