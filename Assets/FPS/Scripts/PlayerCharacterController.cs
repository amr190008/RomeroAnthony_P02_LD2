...
{
    [Header("References")]
    [Tooltip("Reference to the main cinemachine v-camera used for the player. Used to set FOV")]
    public CinemachineVirtualCamera playerCamera;
    [Tooltip("Reference to camera location desired on the player")]
    public Transform cameraSocket;
    [Tooltip("Reference to the location the camera should aim")]
    ...
    void HandleCharacterMovement()
    {
        ...
        // vertical camera rotation
        {
            ...
            cameraSocket.localEulerAngles = new Vector3(m_CameraVerticalAngle, 0, 0);
        }
    ...
    void UpdateCharacterHeight(bool force)
    {
        ...
        if (force)
        {
            ...
            cameraSocket.localPosition = Vector3.up * m_TargetCharacterHeight * cameraHeightRatio;
        ...
        else if (m_Controller.height != m_TargetCharacterHeight)
        {
            ...
            m_Controller.center = Vector3.up * m_Controller.height * 0.5f;
            cameraSocket.localPosition = Vector3.Lerp(cameraSocket.localPosition, Vector3.up * m_TargetCharacterHeight * cameraHeightRatio, crouchingSharpness * Time.deltaTime);
            m_Actor.aimPoint.transform.localPosition = m_Controller.center;
        }
    }
