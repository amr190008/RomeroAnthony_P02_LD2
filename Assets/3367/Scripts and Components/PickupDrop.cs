...
public class PickupDrop : MonoBehaviour
{
	...
	void Update ()
	{
		...
		else
		{
			...
			heldObject.transform.rotation = pickupLocation.rotation;
	...
	void PickupObject ()
	{
		...
		if (Physics.Raycast(pickupLocation.position, pickupLocation.TransformDirection(Vector3.forward), out hitInfo, pickupDistance, pickupMask))
		{
